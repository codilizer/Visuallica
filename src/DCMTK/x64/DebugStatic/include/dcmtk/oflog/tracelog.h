...
public:
    ...
    { if(logger.isEnabledFor(TRACE_LOG_LEVEL))
          logger.forcedLog(TRACE_LOG_LEVEL,(const char*) DCMTK_LOG4CPLUS_TEXT("ENTER: ") + msg, file, line); 
    }

    ~TraceLogger()
    { if(logger.isEnabledFor(TRACE_LOG_LEVEL))
		logger.forcedLog(TRACE_LOG_LEVEL, (const char*)DCMTK_LOG4CPLUS_TEXT("EXIT:  ") + msg, file, line);
    }
